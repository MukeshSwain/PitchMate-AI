...
const testimonials = [
  ...
  {
    name: "Priya M.",
    text: "PitchMate AI made my emails effortless, and the resume checker got me noticed!",
      ...
      <div className="mt-24 max-w-5xl mx-auto">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {testimonials.map((t, idx) => (
            <motion.div
              key={idx}
              className="bg-gray-800 border border-gray-700 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
